// var widgetBar = document.getElementsByClassName('dos');
// widgetBar.innerHTML = "sff"

console.log("testtt")

$(document).ready(function() {   // Load the function after DOM ready.

var link1=chrome.extension.getURL("images/icon_19.png");     //Get absolute path of the file residing your extension.
var t1='<div id="pop"><a href=""><img id="mgt" src="'+link1+'"width="25" height="24"></a></div>'    //now set the src to absolute path.
$("body").prepend(t1);     //Insert MailGet icon into top-right corner of Gmail home.

// var link2=chrome.extension.getURL("images/icon_19.png");
// var link3=chrome.extension.getURL("images/icon_19.png");
